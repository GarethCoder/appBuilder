...
define(['aisclient'], function(_){
    var Process = function(){
        ...
        self.selectRow = function(inputRow) {
            ...
            var reqObj = _.buildAppstackJSON(optionsObj,"1.0","116");

            _.getForm("appstack",reqObj).then(function(data){
                if (data.hasOwnProperty("fs_P41026_W41026G")) {
                    var errObj = data.fs_P41026_W41026G.errors;
                    if (errObj.length > 0) {
                        _.getErrorMsgs(errObj);
                        _.returnFromError();
                    } else if (inputRow.EXTRACT) {
                        _.postSuccess("Extracting data");
                        _.appendTable(data.fs_P41026_W41026G.data);
                    } else {
                        _.postSuccess("Entering the Category Codes form");
                        window.globals.htmlInputs = data.fs_P41026_W41026G.data;
                    ...
                    if (errObj.length > 0) {
                        ...
                        _.postError("There was a problem entering the Category Codes form");
                        _.returnFromError();
                    }
                } else {
                    _.postError("An unknown error occurred in the find/browse form");
            ...
            _.getForm("appstack",reqObj).then(function(data){
                if (data.hasOwnProperty("fs_P41026_W41026G")) {
                    ...
                    if (errObj.length > 0) {
                        ...
                        _.postSuccess("Item Branch/Plant Category Codes updated");
                        _.returnFromSuccess();
                    }
                } else {
